    ...
    while(j < 600000){
        ...
        if(nn == 2){
            if(RecieveChar[0] == 65535){
                if(i != 0){
                    i = 0;
                    printf("%x%x%x%x%x%x%x%x%x%x%x%x\n", RecieveData[0],RecieveData[1],RecieveData[2],RecieveData[3],RecieveData[4],RecieveData[5],RecieveData[6],RecieveData[7],RecieveData[8],RecieveData[9],RecieveData[10],RecieveData[11]);
                    j++;
                }
            } else {
